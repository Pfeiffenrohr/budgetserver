...
public interface TransactionRepository extends CrudRepository<Transaction, Integer> {
	...
	@Query(value= "select sum(wert) as summe from transaktionen where datum=:datum and kategorie=:categorie",nativeQuery = true )
	String findSumByMonth(@Param("datum") Date datum,@Param("categorie") Integer categorie);
